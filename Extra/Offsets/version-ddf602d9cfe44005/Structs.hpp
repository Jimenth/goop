...
namespace structs {
    ...
    struct DataModel {
        ...
        char pad_3[0x3C8];
        uintptr_t ServerIP;  // 0x558
        char pad_4[0x10];
        uint32_t GameLoaded;  // 0x570
    };  // sizeof = 0x574
