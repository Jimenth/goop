...
// clang-format off
namespace offsets {
    inline constexpr const char* roblox_version = "version-ce0bcd0fbd484804";
    ...
    namespace Creator {
        inline constexpr uintptr_t MapEnd = 0x82D7A68;
        inline constexpr uintptr_t MapStart = 0x82D7A60;
    }
    ...
    namespace Fire {
        inline constexpr uintptr_t FireProximityPrompt = 0x30C3170;
    }
    ...
    namespace Functions {
        inline constexpr uintptr_t Clone = 0x15F8B80; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Destroy = 0x15F8BA0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRay = 0xEA7BE0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithIgnoreList = 0xEA7C60; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithWhitelist = 0xEA7CF0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FireServer = 0xC901C0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Print = 0x1C68F60;
        inline constexpr uintptr_t RaisePropertyChanged = 0x3DB6910;
        inline constexpr uintptr_t Raycast = 0xE9F200; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t SetParent = 0xB01080;
        inline constexpr uintptr_t SetParentInternal = 0x1BF64F0;
        inline constexpr uintptr_t Shapecast = 0xEA0BC0; // better to resolve at runtime via func descriptors
    }
    ...
    namespace TextButton {
        ...
        inline constexpr uintptr_t TextTruncate = 0x1158;
    ...
    namespace Types {
        inline constexpr uintptr_t AllTypes = 0x87C9458;
    }
