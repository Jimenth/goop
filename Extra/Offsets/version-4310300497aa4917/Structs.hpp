...
namespace structs {
    ...
    struct DataModel {
        char pad_0[0x120];
        uintptr_t JobId;  // 0x120
        char pad_1[0x38];
        uintptr_t Workspace;  // 0x160
        char pad_2[0x20];
        uint64_t CreatorId;  // 0x188
        uint64_t GameId;  // 0x190
        uint64_t PlaceId;  // 0x198
        char pad_3[0x428];
        uintptr_t ServerIP;  // 0x5C8
        char pad_4[0x10];
        uint32_t GameLoaded;  // 0x5E0
    };  // sizeof = 0x5E4
    ...
    struct Primitive {
        ...
        char pad_1[0xC6];
        uint8_t PrimitiveFlags;  // 0x1BE
        char pad_2[0x5];
        Vector3 Size;  // 0x1C4
        char pad_3[0x48];
        uintptr_t Part;  // 0x218
        char pad_4[0x2E];
        uint16_t Material;  // 0x24E
    };  // sizeof = 0x250
