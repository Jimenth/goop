...
// clang-format off
namespace offsets {
    inline constexpr const char* roblox_version = "version-17d504d2c9544583";
    ...
    namespace Creator {
        inline constexpr uintptr_t MapEnd = 0x82DAD68;
        inline constexpr uintptr_t MapStart = 0x82DAD60;
    }
    ...
    namespace Fire {
        inline constexpr uintptr_t FireProximityPrompt = 0x30C6E20;
    }
    ...
    namespace Functions {
        inline constexpr uintptr_t Clone = 0x15F9FB0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Destroy = 0x15F9FD0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRay = 0xEA8890; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithIgnoreList = 0xEA8910; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithWhitelist = 0xEA89A0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FireServer = 0xC90E70; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Print = 0x1C6A390;
        inline constexpr uintptr_t Raycast = 0xE9FEB0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t SetParent = 0xE6FC00;
        inline constexpr uintptr_t SetParentInternal = 0x1BF7920;
        inline constexpr uintptr_t Shapecast = 0xEA1870; // better to resolve at runtime via func descriptors
    }
    ...
    namespace Types {
        inline constexpr uintptr_t AllTypes = 0x87CC968;
    }
