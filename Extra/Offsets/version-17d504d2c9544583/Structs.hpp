...
namespace structs {
    ...
    struct DataModel {
        ...
        char pad_3[0x418];
        uintptr_t ServerIP;  // 0x5A8
        char pad_4[0x10];
        uint32_t GameLoaded;  // 0x5C0
    };  // sizeof = 0x5C4
    ...
    struct Terrain {
        ...
        char pad_1[0x4];
        float GrassLength;  // 0x1E8
        char pad_2[0x4];
        float WaterReflectance;  // 0x1F0
        float WaterTransparency;  // 0x1F4
        float WaterWaveSize;  // 0x1F8
        float WaterWaveSpeed;  // 0x1FC
        char pad_3[0x290];
        uintptr_t MaterialColors;  // 0x490
    };  // sizeof = 0x498
    ...
    struct TextButton {
        ...
        char pad_7[0x109];
        Color3 TextColor3;  // 0x1128
        Color3 TextStrokeColor3;  // 0x1134
        char pad_8[0x4];
        int32_t MaxVisibleGraphemes;  // 0x1144
        char pad_9[0x4];
        float TextSize;  // 0x114C
        float TextStrokeTransparency;  // 0x1150
        float TextTransparency;  // 0x1154
        uint8_t TextTruncate;  // 0x1158
        char pad_10[0x3];
        uint8_t TextXAlignment;  // 0x115C
    };  // sizeof = 0x115D

    struct TextLabel {
        char pad_0[0xB71];
        bool TextScaled;  // 0xB71
        char pad_1[0x12E];
        ...
        bool RichText;  // 0xD9E
        char pad_6[0x109];
        Color3 TextColor3;  // 0xEA8
        Color3 TextStrokeColor3;  // 0xEB4
        char pad_7[0x4];
        int32_t MaxVisibleGraphemes;  // 0xEC4
        char pad_8[0x4];
        float TextSize;  // 0xECC
        float TextStrokeTransparency;  // 0xED0
        float TextTransparency;  // 0xED4
        uint8_t TextTruncate;  // 0xED8
        char pad_9[0x3];
        uint8_t TextXAlignment;  // 0xEDC
    };  // sizeof = 0xEDD
    ...
    struct Workspace {
        char pad_0[0x3F0];
        uintptr_t World;  // 0x3F0
        char pad_1[0xA0];
        uintptr_t CurrentCamera;  // 0x498
        char pad_2[0x528];
        float ReadOnlyGravity;  // 0x9C8
    };  // sizeof = 0x9CC
    ...
    struct World {
        ...
        float Gravity;  // 0x210
        char pad_1[0xC];
        uintptr_t AirProperties;  // 0x220
        char pad_2[0x68];
        uintptr_t Primitives;  // 0x290
        char pad_3[0x470];
        float WorldSteps;  // 0x708
    };  // sizeof = 0x70C
