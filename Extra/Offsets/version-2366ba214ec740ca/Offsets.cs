...
namespace RobloxOffsets
{
    ...
    {
        public const string RobloxVersion = "version-2366ba214ec740ca";
    }
    ...
    {
        public const ulong Animation = 0xA8;
        public const ulong Animator = 0x100;
        public const ulong IsPlaying = 0x522;
        public const ulong Looped = 0xD5;
        public const ulong Speed = 0xC4;
        public const ulong TimePosition = 0xC8;
    }

    public static class Animator
    {
        public const ulong ActiveAnimations = 0xA80;
    }
    ...
    {
        public const ulong Position = 0xB4;
    }
    ...
    {
        public const ulong Attachment0 = 0x150;
        public const ulong Attachment1 = 0x160;
        public const ulong Brightness = 0x170;
        public const ulong CurveSize0 = 0x174;
        public const ulong CurveSize1 = 0x178;
        public const ulong LightEmission = 0x17C;
        public const ulong LightInfluence = 0x180;
        public const ulong Texture = 0x130;
        public const ulong TextureLength = 0x18C;
        public const ulong TextureSpeed = 0x194;
        public const ulong Width0 = 0x198;
        public const ulong Width1 = 0x19C;
        public const ulong ZOffset = 0x1A0;
    }

    public static class BloomEffect
    {
        public const ulong Enabled = 0xA0;
    ...
    public static class Camera
    {
        ...
        public const ulong CameraType = 0x128;
        public const ulong FieldOfView = 0x130;
        public const ulong ImagePlaneDepth = 0x2C4;
        public const ulong Position = 0xEC;
        public const ulong Rotation = 0xC8;
        public const ulong ViewportInt16 = 0x27C;
        public const ulong ViewportSize = 0x2BC;
    }
    ...
    {
        public const ulong MaxActivationDistance = 0xD8;
        public const ulong MouseIcon = 0xB8;
    }

    public static class Clothing
    {
        public const ulong Color3 = 0x110;
        public const ulong Template = 0xF0;
    }

    public static class ColorCorrectionEffect
    {
        public const ulong Brightness = 0xB4;
        public const ulong Contrast = 0xB8;
        public const ulong Enabled = 0xA0;
        public const ulong TintColor = 0xA8;
    }

    public static class ColorGradingEffect
    {
        public const ulong Enabled = 0xA0;
        public const ulong TonemapperPreset = 0xA8;
    }

    public static class Creator
    {
        public const ulong MapEnd = 0x81FEB80;
        public const ulong MapStart = 0x81FEB78;
    }
    ...
    {
        public const ulong Enabled = 0xA0;
        public const ulong FarIntensity = 0xA8;
        public const ulong FocusDistance = 0xAC;
        public const ulong InFocusRadius = 0xB0;
        public const ulong NearIntensity = 0xB4;
    }
    ...
    {
        public const ulong ActivatedCursorIcon = 0x1B0;
        public const ulong CursorIcon = 0xB8;
        public const ulong MaxActivationDistance = 0xD8;
        public const ulong MaxDragAngle = 0x298;
        public const ulong MaxDragTranslation = 0x25C;
        public const ulong MaxForce = 0x29C;
        public const ulong MaxTorque = 0x2A0;
        public const ulong MinDragAngle = 0x2A4;
        public const ulong MinDragTranslation = 0x268;
        public const ulong ReferenceInstance = 0x1E0;
        public const ulong Responsiveness = 0x2B0;
    }

    public static class FakeDataModel
    {
        public const ulong Pointer = 0x8EE1728;
    ...
    {
        public const ulong FireProximityPrompt = 0x31BD800;
    }
    ...
    {
        public const ulong Clone = 0x156B000;
        public const ulong Destroy = 0x156B020;
        public const ulong FindPartOnRay = 0xDDE010;
        public const ulong FindPartOnRayWithIgnoreList = 0xDDE090;
        public const ulong FindPartOnRayWithWhitelist = 0xDDE120;
        public const ulong FireServer = 0xBB5F80;
        public const ulong Print = 0x1CFA0D0;
        public const ulong RaisePropertyChanged = 0xE8F720;
        public const ulong Raycast = 0xDD5640;
        public const ulong SetParent = 0xDCFD00;
        public const ulong SetParentInternal = 0x1D41210;
        public const ulong Shapecast = 0xDD7000;
    }
    ...
    public static class GuiObject
    {
        ...
        public const ulong Image = 0x990;
        ...
        public const ulong ScreenGui_Enabled = 0x4B4;
    ...
    public static class Humanoid
    {
        ...
        public const ulong FloorMaterial = 0x174;
        ...
        public const ulong HumanoidRootPart = 0x458;
        public const ulong HumanoidState = 0x8A0;
        public const ulong HumanoidStateID = 0x20;
        public const ulong IsWalking = 0xA1F;
        public const ulong Jump = 0x1CA;
        ...
        public const ulong MoveDirection = 0x130;
        public const ulong MoveToPart = 0x108;
        public const ulong NameDisplayDistance = 0x1A0;
        public const ulong NameOcclusion = 0x1A4;
        public const ulong PlatformStand = 0x1CC;
    ...
    {
        public const ulong AssetID = 0x10;
        public const ulong CachedItem = 0x38;
    ...
    public static class Lighting
    {
        ...
        public const ulong GlobalShadows = 0x134;
        public const ulong GradientBottom = 0x180;
        public const ulong GradientTop = 0x140;
        public const ulong LightColor = 0x14C;
        public const ulong LightDirection = 0x158;
        public const ulong MoonPosition = 0x174;
        ...
        public const ulong SunPosition = 0x168;
    }
    ...
    public static class LocalScript
    {
        ...
        public const ulong GUID = 0xC0;
        public const ulong Hash = 0x190;
    }
    ...
    {
        public const ulong Adornee = 0xE0;
        public const ulong AnimationId = 0xB0;
    ...
    public static class MouseService
    {
        ...
        public const ulong MousePosition = 0xC4;
        public const ulong SensitivityPointer = 0x0;
    }

    public static class ParticleEmitter
    {
        public const ulong Acceleration = 0x1D0;
        public const ulong Brightness = 0x20C;
        public const ulong Drag = 0x210;
        public const ulong Lifetime = 0x1E4;
        public const ulong LightEmission = 0x228;
        public const ulong LightInfluence = 0x22C;
        public const ulong Rate = 0x238;
        public const ulong RotSpeed = 0x1EC;
        public const ulong Rotation = 0x1F4;
        public const ulong Speed = 0x1FC;
        public const ulong SpreadAngle = 0x204;
        public const ulong Texture = 0x1B0;
        public const ulong TimeScale = 0x24C;
        public const ulong VelocityInheritance = 0x250;
        public const ulong ZOffset = 0x254;
    }

    public static class Player
    {
        public const ulong AccountAge = 0x34C;
        public const ulong CameraMode = 0x360;
        public const ulong Character = 0x288;
        public const ulong DisplayName = 0x128;
        public const ulong HealthDisplayDistance = 0x384;
        public const ulong LocalPlayer = 0x120;
        public const ulong LocaleId = 0x740;
        public const ulong MaxZoomDistance = 0x358;
        public const ulong MinZoomDistance = 0x35C;
        public const ulong Mouse = 0x1200;
    ...
    {
        public const ulong Icon = 0xB8;
        public const ulong Workspace = 0x140;
    }
    ...
    public static class ProximityPrompt
    {
        ...
        public const ulong GamepadKeyCode = 0x10C;
    ...
    public static class RenderView
    {
        ...
        public const ulong SkyValid = 0x0;
        public const ulong SkyboxValid = 0x28D;
    }

    public static class RunService
    {
        public const ulong HeartbeatFPS = 0xC0;
        public const ulong HeartbeatTask = 0xE0;
    }
    ...
    {
        public const ulong RequireBypass = 0xAAE;
    }
    ...
    {
        public const ulong IsPlaying = 0x130;
        public const ulong Looped = 0x12D;
        public const ulong PlaybackSpeed = 0x10C;
        public const ulong RollOffMaxDistance = 0x110;
        public const ulong RollOffMinDistance = 0x114;
        public const ulong SoundGroup = 0xD8;
        public const ulong SoundId = 0xB8;
        public const ulong Volume = 0x120;
    }

    public static class SpawnLocation
    {
        public const ulong AllowTeamChangeOnTouch = 0x3D;
        public const ulong Enabled = 0x1E1;
        public const ulong ForcefieldDuration = 0x1D8;
        public const ulong Neutral = 0x1E2;
        public const ulong TeamColor = 0x1DC;
    }
    ...
    {
        public const ulong Value = 0xF80;
    }
    ...
    public static class SunRaysEffect
    {
        public const ulong Enabled = 0xA0;
        public const ulong Intensity = 0xA8;
        public const ulong Spread = 0xAC;
    }

    public static class SurfaceAppearance
    {
        public const ulong AlphaMode = 0x1E0;
        public const ulong Color = 0x1C8;
        public const ulong ColorMap = 0xB8;
        public const ulong EmissiveMaskContent = 0xE8;
        public const ulong EmissiveStrength = 0x1E4;
        public const ulong EmissiveTint = 0x1D4;
        public const ulong MetalnessMap = 0x118;
        public const ulong NormalMap = 0x148;
        public const ulong RoughnessMap = 0x178;
    }

    public static class TaskScheduler
    {
        public const ulong JobEnd = 0xD0;
        public const ulong JobName = 0x8E0;
        public const ulong JobStart = 0xC8;
        public const ulong MaxFPS = 0xB0;
        public const ulong Pointer = 0x8C8D108;
    }
    ...
    public static class Terrain
    {
        ...
        public const ulong MaterialColors = 0x4A8;
    ...
    public static class TextButton
    {
        ...
        public const ulong RichText = 0x101E;
    ...
    public static class TextLabel
    {
        ...
        public const ulong TextScaled = 0xD96;
    ...
    {
        public const ulong Decal_Texture = 0x1D0;
    }
    ...
    public static class Tool
    {
        ...
        public const ulong TextureId = 0x350;
        public const ulong Tooltip = 0x458;
    }

    public static class Types
    {
        public const ulong AllTypes = 0x8A782F8;
    }

    public static class UnionOperation
    {
        public const ulong AssetId = 0x300;
    }

    public static class UserInputService
    {
        public const ulong WindowInputState = 0x2B0;
    }
    ...
    public static class VisualEngine
    {
        ...
        public const ulong Pointer = 0x851BF08;
    ...
    {
        public const ulong Part0 = 0x108;
        public const ulong Part1 = 0x118;
    }

    public static class WeldConstraint
    {
        public const ulong Part0 = 0xA8;
        public const ulong Part1 = 0xB8;
    }
    ...
    public static class Workspace
    {
        ...
        public const ulong DistributedGameTime = 0x4C8;
    ...
    {
        public const ulong AirProperties = 0x240;
        public const ulong FallenPartsDestroyHeight = 0x220;
        public const ulong Gravity = 0x228;
        public const ulong Primitives = 0x2B0;
        public const ulong WorldSteps = 0x728;
    }
