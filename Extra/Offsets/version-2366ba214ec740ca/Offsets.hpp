...
// clang-format off
namespace offsets {
    inline constexpr const char* roblox_version = "version-2366ba214ec740ca";
    ...
    namespace Creator {
        inline constexpr uintptr_t MapEnd = 0x81FEB80;
        inline constexpr uintptr_t MapStart = 0x81FEB78;
    }
    ...
    namespace Functions {
        inline constexpr uintptr_t Clone = 0x156B000; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Destroy = 0x156B020; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRay = 0xDDE010; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithIgnoreList = 0xDDE090; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithWhitelist = 0xDDE120; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FireServer = 0xBB5F80; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Print = 0x1CFA0D0;
        inline constexpr uintptr_t RaisePropertyChanged = 0xE8F720;
        inline constexpr uintptr_t Raycast = 0xDD5640; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t SetParent = 0xDCFD00;
        inline constexpr uintptr_t SetParentInternal = 0x1D41210;
        inline constexpr uintptr_t Shapecast = 0xDD7000; // better to resolve at runtime via func descriptors
    }
    ...
    namespace TaskScheduler {
        ...
        inline constexpr uintptr_t JobName = 0x8E0;
